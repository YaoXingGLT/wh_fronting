...
"""
    Loki module for fronting_where
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("李四喜歡台北", "李四喜歡台北", [], {}, {})
    pprint(resultDICT)