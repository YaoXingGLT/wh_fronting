...
def testIntent():
    ...
    # fronting_what
    print("[TEST] fronting_what")
    inputLIST = ['張三買了衛生紙','張三不喜歡買衛生紙','張三應該會買衛生紙','每個人都會買衛生紙','馬曉莉最喜歡衛生紙','李四到台北找到衛生紙','李四買過好幾次衛生紙']
    testLoki(inputLIST, ['fronting_what'])
    print("")

    # fronting_who
    print("[TEST] fronting_who")
    inputLIST = ['張三不喜歡王小明','馬小莉喜歡王小明','馬小莉最喜歡王小明','王小名不給馬曉莉看照片','馬曉莉見過王曉明很多次','馬曉莉想看王曉明拍的照片']
    testLoki(inputLIST, ['fronting_who'])
    print("")

    # fronting_where
    print("[TEST] fronting_where")
    inputLIST = ['李四喜歡台北','張三不喜歡台北','張三騎機車去台北','張三去台北玩好幾次','張三和李四去台北玩','張三在台北看到瑪麗','李四到台北找到張三','張三和李四在台北見面']
    testLoki(inputLIST, ['fronting_where'])
    print("")
